    ...
    if cfg.MODEL.DEPTH in [50, 101]:
        ...
        if cfg.MODEL.USE_AFFINE is False:
            blob_in, dim_in = resnet_helper.res_stage_nonlocal(
                ...
                pool_stride=pool_stride, spatial_dim=(int(crop_size / 8)),
        ...
        blob_in, dim_in = resnet_helper.res_stage_nonlocal(
            ...
            batch_size=batch_size, 
            pool_stride=pool_stride, spatial_dim=(int(crop_size / 16)),
            nonlocal_name='nonlocal_conv4', nonlocal_mod=layer_mod)
